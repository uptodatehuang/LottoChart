package com.yunkaitech.lottochart.web.rest.errors;
...
public class ExceptionTranslator extends ResponseEntityExceptionHandler {
    ...
    private ProblemDetailWithCause getProblemDetailWithCause(Throwable ex) {
        if (
            ex instanceof com.yunkaitech.lottochart.service.EmailAlreadyUsedException ||
            ex instanceof com.yunkaitech.lottochart.service.UsernameAlreadyUsedException
        ) {
        ...
        if (
            ex instanceof com.yunkaitech.lottochart.service.InvalidPasswordException
